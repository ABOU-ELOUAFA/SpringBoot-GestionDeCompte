...
public class SpringBootGestionDeCompteApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		/*
		 * Client c1 = clientRepository.save(new Client("Amine",
		 * "aminekhan.14@gmail.com")); Client c2 = clientRepository.save(new
		 * Client("ahmed", "ahmedkhan.15@gmail.com"));
		 * 
		 * Compte cp1 = compteRepository.save(new CompteCourant(new Date(), 9000.0, c1,
		 * 6000.0)); Compte cp2 = compteRepository.save(new CompteEpargne(new Date(),
		 * 8000.0, c2, 5.0));
		 * 
		 ...
		 * 
		 * Operation op1 = operationRepository.save(new Retrait(new Date(), 4000.0,
		 * cp1));
		 * 
		 ...
		 * 
		 * Operation op2 = operationRepository.save(new Retrait(new Date(), 3000.0,
		 * cp2));
		 * 
		 * iMetier.verser(1, 2000); iMetier.retirer(1, 11000);
		 * 
		 * iMetier.consulteerOperatio(1, 0, 4);
		 */
